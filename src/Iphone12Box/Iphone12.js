...
function Iphone12() {
    return (
        ...
        <div >
                    ...
                    <h1 className="font-bold  text-5xl text-gray-600">Buy iPhone 12</h1>
                    ...
                    <button className="bg-white border-blue-700  border-2 w-96   mt-4 text-black  h-20 rounded-md hover:bg-gray-300">iPhone 12 mini<br/><h1 className="text-xs font-light">5.4-inch display</h1></button>
                   
                    <button className="bg-white border-blue-700  border-2 w-96   mt-4 text-black  h-20 rounded-md hover:bg-gray-300">iPhone 12 mini<br/><h1 className="text-xs font-light">6.1-inch display</h1></button>
